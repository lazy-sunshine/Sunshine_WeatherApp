...
import com.example.dell.sunshine.data.WeatherContract.LocationEntry;
    ...
    public void testBasicLocationQueries() {
      //   insert our test records into the database
        ...
        TestUtilities.validateCursor("testBasicLocationQueries, location query", locationCursor, testValues);
         ...
         //evel 19 or greater because getNotificationUri was added in API level 19.
    ...
    //     Create a new map of values, where column names are the keys
       ...
       //  Verify we got a row back.
        ...
        assertEquals(count, 1);
         ...
         //tudents: If your code is failing here, it means that your content provider
